...
public class BuySell {
    ...
    public int getMaster_project_type_id() {
        return master_project_type_id;
    }

    public void setMaster_project_type_id(int master_project_type_id) {
        this.master_project_type_id = master_project_type_id;
    }

    public int getMaster_project_category_id() {
        return master_project_category_id;
    }

    public void setMaster_project_category_id(int master_project_category_id) {
        this.master_project_category_id = master_project_category_id;
    }
    ...
    public int getMaster_country_id() {
        return master_country_id;
    }

    public void setMaster_country_id(int master_country_id) {
        this.master_country_id = master_country_id;
    }

    public int getBid_expiry_day() {
        return bid_expiry_day;
    }

    public void setBid_expiry_day(int bid_expiry_day) {
        this.bid_expiry_day = bid_expiry_day;
    }

    public int getMaster_agreement_type_id() {
        return master_agreement_type_id;
    }

    public void setMaster_agreement_type_id(int master_agreement_type_id) {
        this.master_agreement_type_id = master_agreement_type_id;
    }

    public int getCost_sharing() {
        return cost_sharing;
    }

    public void setCost_sharing(int cost_sharing) {
        this.cost_sharing = cost_sharing;
    }

    public int getMaster_cost_sharing_unit_id() {
        return master_cost_sharing_unit_id;
    }

    public void setMaster_cost_sharing_unit_id(int master_cost_sharing_unit_id) {
        this.master_cost_sharing_unit_id = master_cost_sharing_unit_id;
    }

    public int getAverage_monthly_payment() {
        return average_monthly_payment;
    }

    public void setAverage_monthly_payment(int average_monthly_payment) {
        this.average_monthly_payment = average_monthly_payment;
    }

    public int getAmp_master_currency_id() {
        return amp_master_currency_id;
    }

    public void setAmp_master_currency_id(int amp_master_currency_id) {
        this.amp_master_currency_id = amp_master_currency_id;
    }

    public Object getLeasing_tariff() {
        return leasing_tariff;
    }

    public void setLeasing_tariff(Object leasing_tariff) {
        this.leasing_tariff = leasing_tariff;
    }

    public int getLt_master_currency_id() {
        return lt_master_currency_id;
    }

    public void setLt_master_currency_id(int lt_master_currency_id) {
        this.lt_master_currency_id = lt_master_currency_id;
    }
    ...
    public int getMaster_capacity_unit_id() {
        return master_capacity_unit_id;
    }

    public void setMaster_capacity_unit_id(int master_capacity_unit_id) {
        this.master_capacity_unit_id = master_capacity_unit_id;
    }

    public int getTenure_length() {
        return tenure_length;
    }

    public void setTenure_length(int tenure_length) {
        this.tenure_length = tenure_length;
    }

    public int getTenure_age() {
        return tenure_age;
    }

    public void setTenure_age(int tenure_age) {
        this.tenure_age = tenure_age;
    }

    public int getMaster_module_specification_id() {
        return master_module_specification_id;
    }

    public void setMaster_module_specification_id(int master_module_specification_id) {
        this.master_module_specification_id = master_module_specification_id;
    }
    ...
    public int getMaster_grid_connection_id() {
        return master_grid_connection_id;
    }

    public void setMaster_grid_connection_id(int master_grid_connection_id) {
        this.master_grid_connection_id = master_grid_connection_id;
    }

    public int getCurrent_tenancy_age() {
        return current_tenancy_age;
    }

    public void setCurrent_tenancy_age(int current_tenancy_age) {
        this.current_tenancy_age = current_tenancy_age;
    }

    public String getMounting_system() {
        return mounting_system;
    }

    public void setMounting_system(String mounting_system) {
        this.mounting_system = mounting_system;
    }
    ...
    public List<ProjectImage> getProject_images() {
        return project_images;
    }

    public void setProject_images(List<ProjectImage> project_images) {
        this.project_images = project_images;
    }

    public List<Object> getProject_documents() {
        return project_documents;
    }

    public void setProject_documents(List<Object> project_documents) {
